...
const NewSteps = () => {
    return (
        <div className="w-full px-[7%] pt-16 mdd:pt-10 pb-16 mdd:pb-10 md:h-[1150px]">
            <h2 className="text-[18px] md:text-[28px] sm:text-[22px] font-medium mb-2">Шаги для получения визы</h2>
            <p className="mdd:w-full w-[60%] mdd:text-[16px] sm:text-[20px] md:text-[20px] lg:text-[20px] font-medium mb-8 lg:mb-16">
