        ...
        <div>
            ...
            <div className="relative mt-[200px] md:mt-[320px]">
                ...
                <div
                    ...
                    <div className="w-[80%] mdd:w-full flex flex-col gap-4">
                        <h2 className="text-[18px] md:text-[28px] sm:text-[22px] font-medium">Ошибка №1: Несоответствие документов требованиям работодателя и консульства</h2>
                    ...
                    <div className="w-[80%] mdd:w-full flex flex-col gap-4">
                        <h2 className="text-[18px] md:text-[28px] sm:text-[22px] font-medium">Ошибка №2: Недооценка финансовых требований</h2>
                    ...
                    <div className="w-[80%] mdd:w-full flex flex-col gap-4">
                        <h2 className="text-[18px] md:text-[28px] sm:text-[22px] font-medium">Ошибка №3: Неправильная или неполная информация в анкете</h2>
                    ...
                    <div className="w-[80%] mdd:w-full flex flex-col gap-4">
                        <h2 className="text-[18px] md:text-[28px] sm:text-[22px] font-medium">Ошибка №4: Неубедительная мотивация и слабая подготовка к собеседованию</h2>
                    ...
                    <div className="w-[80%] mdd:w-full flex flex-col gap-4">
                        <h2 className="text-[18px] md:text-[28px] sm:text-[22px] font-medium">Ошибка №5: Игнорирование сроков и "человеческого фактора"</h2>
                    ...
                    <div className="w-[80%] mdd:w-full flex flex-col gap-4">
                        <h2 className="text-[18px] md:text-[28px] sm:text-[22px] font-medium">Чек-лист для успешного получения рабочей визы. Избегаем отказа</h2>
                ...
                <div
                    ...
                    <div className="w-[80%] mdd:w-full flex flex-col gap-4">
                        <h2 className="text-[18px] md:text-[28px] sm:text-[22px] font-medium">Не рискуйте своим будущим за границей — доверьтесь профессионалам!</h2>
