        ...
        <div>
            ...
            <div className="relative mt-[200px] md:mt-[320px]">
                ...
                <div
                    ...
                    <div className="w-[80%] mdd:w-full flex flex-col gap-4">
                        ...
                        <p className={"italic text-[14px]"}>
                            ...
                            от проверки документов до записи в визовый центр, значительно повышая ваши шансы на успешное получение визы — <a className="underline cursor-pointer hover:font-normal font-medium text-blue-500" 
                ...
                <div className="w-full relative flex flex-col px-[7%] pt-32 mdd:pt-20 text-[16px] mdd:text-[14px]">
                    ...
                    <Link href="/poleznaya-informasia/top-5-oshibok-pri-podache-na-rabochiu-vizu" className="w-full relative">
                    <div style={{
