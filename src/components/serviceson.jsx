...
export const otherCountries = [
    {
        ...
        text3: "Для подачи документов гражданам Беларуси необходимо обратиться в Консульство США, ближайшее из которых находится в Варшаве. Отсутствие вида на жительство в Польше не является основанием для отказа в приеме заявления на визу.",
        text4: "Процесс оформления включает **регистрацию на сайте, заполнение визовой анкеты, оплату пошлины и личное собеседование с Консулом** на английском или русском языке. Мы подберем оптимальную страну для подачи заявления, подготовим необходимые документы и запишем вас в Консульство на удобную дату.",
        priceGood: 0,
