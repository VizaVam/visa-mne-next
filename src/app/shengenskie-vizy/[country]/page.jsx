...
const countries = [
    ...
    },
    {
        ...
        title: "Виза в Германию для белорусов: оформление и запись в Минске",
        description: "Оформить шенгенскую визу в Германию для белорусов: запись на подачу, помощь с документами и анкетой в Минске. Доступная стоимость, срочное оформление."
    },
    {
        name: "Испания",
        url: "viza-v-ispaniyu",
        title: "Виза в Испанию для белорусов: оформление и запись в Минске",
        description: "Оформить визу в Испанию для белорусов: шенгенская виза, запись на подачу, помощь с документами и анкетой в Минске и Москве. Доступная стоимость, срочное оформление."
    },
    {
        name: "Франция",
    ...
    },
    {
        name: "Греция",
        url: "viza-v-grecziyu",
        title: "Виза в Грецию для белорусов 2025 | Оформление, стоимость, запись - VISA VAM",
        description: "Оформление визы в Грецию для белорусов. Помощь в получении визы под ключ. Доступная стоимость, запись на подачу и подготовка документов. Гарантия результата!"
    },
    {
        name: "Венгрия",
        url: "viza-v-vengriyu",
        title: "Виза в Венгрию для белорусов | Получение венгерской визы в Минске",
        description: "Поможем открыть визу в Венгрию для белорусов. Профессиональная помощь в получении венгерской визы: подача документов, анкета, запись. Узнайте стоимость!"
    },
    {
        name: "Италия",
        url: "viza-v-italiyu",
        title: "Виза в Италию для белорусов | Запись на шенгенскую визу в Минске",
        description: "Оформление шенгенской визы в Италию для белорусов. Помощь в получении итальянской визы: запись на подачу, заполнение анкеты, подготовка документов. Доступная стоимость."
    },
    {
        name: "Румыния",
        url: "viza-v-rumyniyu",
    ...
    },
    {
        ...
        title: "Рабочая виза в Польшу для белорусов | Оформление национальной визы D",
        description: "Поможем оформить рабочую визу в Польшу (национальная виза D) для белорусов. Быстрая запись, подготовка документов и анкеты. Доступные цены на визовую поддержку."
    },
    {
