            ...
            <div className="relative mt-[200px] md:mt-[320px]">
                ...
                <div
                    ...
                    <div className="w-[80%] mdd:w-full flex flex-col gap-4">
                        ...
                        <p>Команда визового агентства <Link href="/" className="underline hover:font-medium cursor-pointer" target="_blank" rel="noopener noreferrer">VISA VAM</Link> за годы практики изучила все "подводные камни" этого процесса. Мы собрали для вас <span className={"font-bold"}>топ-5</span> самых частых и обидных <span className={"font-bold"}>ошибок</span>, которые допускают белорусы <span className={"font-bold"}>при подаче на рабочую визу</span>, чтобы вы могли учиться на чужом опыте, а не на своем.</p>
                        <p className={"italic text-[14px]"}>💡 <span className={"font-bold"}>Совет:</span> Срочно необходима рабочая виза с минимальным процентом отказа? Рекомендуем рассмотреть <Link href="/shengenskie-vizy/rabochaya-viza-v-germaniyu" className="underline hover:font-medium cursor-pointer" target="_blank" rel="noopener noreferrer">немецкую рабочую визу</Link> (Тип D) без верификации. Без проверок и собеседований, на 365 дней, быстрое рассмотрение - минимум отказов. Торопитесь - предложение ограничено!</p>
                    </div>
                    <div className="w-[80%] mdd:w-full flex flex-col gap-4">
                    ...
                    <div className="w-[80%] mdd:w-full flex flex-col gap-4">
                        ...
                        <p>Если по вашей визе предусмотрено собеседование в консульстве (самый частый вариант – <Link href="/viza-v-ssha" className="underline hover:font-medium cursor-pointer" target="_blank" rel="noopener noreferrer">виза в США</Link>), будьте готовы к тому, что это неформальный разговор. Его цель – убедиться в ваших истинных намерениях.</p>
                        <div className="flex flex-col gap-2">
                            <div className="flex gap-2 items-start">
                    ...
                    <div className="w-[80%] mdd:w-full flex flex-col gap-4">
                        ...
                        <ul className="text-black flex flex-col gap-2">
                            ...
                            <li className="flex gap-2 items-center">
                                <Image src="/check-0.png" alt="" width={16} height={16} className="w-4 h-4"/>
                                <p><span className={"font-bold"}>Обратитесь к экспертам VISA VAM</span>, чтобы гарантировать себе спокойствие и уверенность в результате - <a className="underline hover:font-medium cursor-pointer" target="_blank" rel="noopener noreferrer" onClick={openModal}>оставьте заявку</a>.</p>
                            </li>
                        </ul>
                    </div>
                ...
                <div
                    ...
                    <div className="w-[80%] mdd:w-full flex flex-col gap-4">
                        ...
                        <p><span className={"font-bold"}>Получение рабочей визы</span> – это финишная прямая на пути к вашей новой карьере. Не позволяйте досадным ошибкам перечеркнуть ваши планы, которые приведут к <span className={"font-bold"}>отказу в выдаче визы. <a className="underline hover:font-medium cursor-pointer" target="_blank" rel="noopener noreferrer" onClick={openModal}>Свяжитесь с нами</a>, и мы поможем вам пройти этот путь максимально быстро и эффективно!</span></p>
                    </div>
                </div>
                <Contacts/>
            </div>
