...
export const faqData = [
    ...
    },
    {
        ...
        answer: `
            Это означает, что вы можете находиться в странах Шенгенского соглашения не более 90 дней в течение любого 180-дневного периода. Этот период является «плавающим» и отсчитывается назад от каждого дня вашего пребывания. 
        `,
    },
    {
        question: "Сколько денег надо иметь на счету для получения шенгенской визы?",
        answer: `
            Единой фиксированной суммы нет, она зависит от страны назначения и продолжительности поездки. В среднем, консульства ориентируются на сумму от 65 до 100 евро на каждый день пребывания, не считая стоимости жилья и билетов. 
        `,
    },
    {
        question: "В чем разница между визами C и D?",
        answer: `
            Виза типа C (шенгенская) — краткосрочная, для туризма и поездок до 90 дней. Виза типа D (национальная) — долгосрочная, выдается для пребывания в одной стране более 90 дней с целью учебы, работы или воссоединения семьи и является первым шагом к получению вида на жительство. 
        `,
    },
    {
        question: "Какие страны входят в шенген?",
        answer: `
            В Шенгенскую зону входят 29 стран, отменивших пограничный контроль между собой. Среди них большинство стран ЕС (например, Германия, Франция, Италия, Испания), а также Швейцария, Норвегия, Исландия и Лихтенштейн. 
        `,
    },
];
