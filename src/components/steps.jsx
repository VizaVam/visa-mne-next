...
const Steps = () => {
    return (
        <div className="w-full px-[7%] pt-16 mdd:pt-10 pb-16 mdd:pb-10">
            <h2 className="text-[18px] md:text-[28px] sm:text-[22px] font-medium mb-8 lg:mb-16">3 шага для получения визы</h2>
