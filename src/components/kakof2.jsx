...
export default function OnasPage({breadcrumbs}) {
    ...
    const articleSchema = {
        ...
        "datePublished": "2025-06-21T08:00:00+05:00",
            ...
            <div className="relative mt-[200px] md:mt-[320px]">
                ...
                <div
                    ...
                    <div className="w-[80%] mdd:w-full flex flex-col gap-4">
                        ...
                        <p>
                            <span className={"italic text-[14px] font-bold"}>💡 Важно:</span> В Польше перед записью 
                            на подачу документов обязательным этапом является <b>верификация на польскую визу</b>. Это процедура 
                            подтверждения личности и проверки корректности данных заявителя в системе визового центра. 
                            Без прохождения верификации невозможно зарегистрироваться на подачу документов — система 
                            просто не позволит выбрать дату и время. Поэтому после заполнения анкеты рекомендуется сразу 
                            пройти этот шаг, чтобы избежать задержек и технических ошибок при записи.
                        </p>
                        <p>
                            Процесс <b>верификации на польскую визу</b> включает проверку паспортных данных, адреса электронной почты 
                            и другой информации, указанной в анкете. После успешного подтверждения вы получаете доступ к 
                            системе записи и можете выбрать подходящий визовый центр. Подробную инструкцию по прохождению 
                            этого этапа можно найти в статье <Link href="/poleznaya-informasia/verifikaciya-na-polskyu-visy-dlya-belorusov" className="underline cursor-pointer hover:font-normal font-medium text-blue-500" 
                            target="_blank" rel="noopener noreferrer">Верификация на польскую визу для белорусов</Link>.
                        </p>
