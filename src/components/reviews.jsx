...
const reviews = [
    { id: 1, name: "Владимир Зайцев", text: "Выражаю искреннюю признательность за консультации и оформление документов для подачи в визовый центр Польши. \n" +
            "Р.S. Польская гостевая виза получена на срок 1 год при отсутствии визовой истории как таковой.", image: "/r-2.png" },
    { id: 2, name: "Игорь Барташов", text: "Сделали по моей готовой записи документы и переводы за 2 часа. Обратился, приехал в офис, сделали и поехал сразу подаваться! Профессионализм! На подаче в немецком посольстве не задали ни одного вопроса!", image: "/r-2.png" },
    { id: 3, name: "Дмитрий Вольский", text: "Визу получил, 3 месяца. Думал вообще неделя будет, никогда не открывал визы. \n" +
            "Спасибо!", image: "/r-2.png" },
    { id: 4, name: "Аганова Марина", text: "Благодарю менеджеров за профессиональную консультацию по моей нестандартной ситуации. Приехала в Литву в срок, не подвели.", image: "/r-2.png" },
    { id: 5, name: "Ирина Васкина", text: "Открыли польскую туристическую визу на 2 года!! обращаюсь в третий раз в компанию. И сестра моя там делала испанскую визу. Мужу сделали рабочую. Искренне благодарю директора, знакомы лично уже, менеджеров, рекомендую всем своим знакомым.", image: "/r-2.png" },
