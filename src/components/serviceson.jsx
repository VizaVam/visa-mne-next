...
export const otherCountries = [
    {
        ...
        typevbc: ["Туристическая","Гостевая","Условия","Бизнес-виза","Студенческая","Визы членов экипажей", "Виза невесты/визы жены"],
        typevlc: ["asd", "asd", "asd","asd","asd","asd","asd"],
    ...
    },
    {
        ...
        priceTable: [
            { service: "Услуга компании", cost: <span><span
                    className="text-orange-500 md:text-[20px] sm:text-[18px] mdd:text-[18px] whitespace-nowrap font-medium">400</span> бел. руб.</span>, note: "Консультативная работа, помощь в подготовке необходимого пакета документов (включая перевод), запись на подачу визового заявления" },
            { service: "Консульский/сервисный/логистический сбор", cost: "Оплачивается отдельно", note: "Оплачивается лично в консульстве или ВЦ при подаче" },
            { service: "Медицинская страховка", cost: "Оплачивается отдельно", note: "Поможем подобрать оптимальный вариант!" }
        ]
    },
    {
        ...
        priceTitle: "Наши услуги",
        priceVariants: [
            <span>Подготовка полного пакета документов и запись для подачи визового заявления - <span className="text-orange-500 md:text-[20px] sm:text-[18px] mdd:text-[18px]">690</span> бел. руб.</span>,
        ],
        priceTable: [
            { service: "Деловая виза (услуга компании)", cost: <span><span
                    className="text-orange-500 md:text-[20px] sm:text-[18px] mdd:text-[18px] whitespace-nowrap font-medium">690</span> бел. руб.</span>, note: "Консультативная работа, помощь в подготовке необходимого пакета документов (включая перевод), запись на подачу визового заявления" },
            { service: "Консульский/сервисный/логистический сбор", cost: "Оплачивается отдельно", note: "Оплачивается лично в Консульстве КНР при подаче" },
            { service: "Медицинская страховка", cost: "Оплачивается отдельно", note: "Поможем подобрать оптимальный вариант!" }
        ]
    }
];
