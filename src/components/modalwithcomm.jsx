...
import {useCommentModal} from "@/components/modalcontextcomment";
...
const CommentForm = () => {
    const [formData, setFormData] = useState({name: "", phone: "", email: "", usercomment: ""});
    const [errors, setErrors] = useState({});
    const [isSubmitting, setIsSubmitting] = useState(false);
    const [isSuccess, setIsSuccess] = useState(false);
    const [isAgreed, setIsAgreed] = useState(true);
    const {isModalOpen, closeModal} = useCommentModal();
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const {name, phone, email, usercomment} = formData;
    ...
    const handleNewRequest = () => {
        setIsSuccess(false);
        setFormData({name: "", phone: "", email: "", usercomment: ""});
    };
    ...
    return (
        ...
        >
            ...
            >
                ...
                <h2 className="text-2xl font-medium mb-6">Задать вопрос</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <textarea
                                ...
                                className="w-full border border-[#15419E] rounded-full p-3 text-sm resize-none overflow-y-auto"
                                rows={2}
                            />
                            <p className="text-xs flex flex-end justify-end text-gray-500 mt-1">{formData.usercomment.length}/200</p>
                        </div>
