            ...
            <div className={"w-full relative flex flex-col lg:flex-row sm:flex-col justify-between"}>
                <div
                    ...
                    <nav className="mb-4 flex items-center space-x-2 text-gray-600 gap-2">
                        ...
                        {pathname === "/visa" ? (
                            ...
                            <Link href="/visa" className="font-semibold hover:underline active:scale-95 transition-transform duration-150 ease-in-out">Визы</Link>
                        )}
                    </nav>
                ...
                <div className="w-full lg:flex items-center mt-[20%] mdd:mt-[15%] lg:mt-0 relative z-5">
                    <Image
                        ...
                        width={1000}
                        height={1000}
                        className="relative lg:top-[15%] sm:top-0 lg:w-[50%] lg:left-[45%] -z-50 mdd:hidden"
                    />
